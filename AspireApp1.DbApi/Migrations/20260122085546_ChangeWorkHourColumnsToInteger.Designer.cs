...
namespace AspireApp1.BackEnd.Migrations
{
    ...
    [Migration("20260122085546_ChangeWorkHourColumnsToInteger")]
    partial class ChangeWorkHourColumnsToInteger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.Case", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.CaseActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.CaseRelationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.CaseTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.DashboardMetric", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.PreSalesActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.PreSalesProposal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.PreSalesWorkHour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.ProjectTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.RequirementDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.RoleCoverage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.SlaThreshold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.Case", b =>
                {
                    b.HasOne("AspireApp1.DbApi.Models.User", "AssignedToUser")
                        .WithMany()
                    ...
                    b.HasOne("AspireApp1.DbApi.Models.CustomerOrder", "CustomerOrder")
                        .WithMany()
                        .HasForeignKey("CustomerOrderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AspireApp1.DbApi.Models.CustomerSite", "CustomerSite")
                        .WithMany()
                        .HasForeignKey("CustomerSiteId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AspireApp1.DbApi.Models.SystemComponent", "SystemComponent")
                        .WithMany()
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.CaseActivity", b =>
                {
                    b.HasOne("AspireApp1.DbApi.Models.Case", "Case")
                        .WithMany()
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.CaseRelationship", b =>
                {
                    b.HasOne("AspireApp1.DbApi.Models.Case", "RelatedCase")
                        .WithMany()
                        .HasForeignKey("RelatedCaseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AspireApp1.DbApi.Models.Case", "SourceCase")
                        .WithMany()
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.PreSalesActivity", b =>
                {
                    b.HasOne("AspireApp1.DbApi.Models.PreSalesProposal", "PreSalesProposal")
                        .WithMany()
            ...
            modelBuilder.Entity("AspireApp1.DbApi.Models.PreSalesProposal", b =>
                {
                    ...
                    b.HasOne("AspireApp1.DbApi.Models.RequirementDefinition", "RequirementDefinition")
                        .WithMany()

...
Connection string example for local development (in `AspireApp1.DbApi/appsettings.json`):
...
dotnet ef migrations add InitialCreate --project AspireApp1.DbApi --context ProjectDbContext
dotnet ef database update --project AspireApp1.DbApi --context ProjectDbContext
```
